...
def main_worker(args):
    ...
    if args.do_train:
        ...
        if getattr(args, 'refer_clip_preprocess', None):
            train_dataset = BaseDataset(args, args.train_path, split='train', preprocesser=model.feature_extractor)
            eval_dataset = BaseDataset(args, args.val_path, split='val', preprocesser=model.feature_extractor)
        else:
            train_dataset = BaseDataset(args, args.train_path, split='train')
