...
class Args(BasicArgs):
    ...
    fps = 5
    data_dir = "../dataset"
    debug_train_yaml = '../dataset/composite/val_TiktokDance-poses.yaml'
    debug_val_yaml = '../dataset/composite/val_TiktokDance-poses.yaml'
    train_yaml = '../dataset/composite/train_TiktokDance-poses.yaml'
    val_yaml = '../dataset/composite/val_TiktokDance-poses.yaml'
